var content_data = {
    "V":{
        ...
        ["营业收入(F)","y"],
        ["利润总额(C)","b"],
        ["经济增加值(C)","b"],"提升价值创造能力,5"
        ],
        "2":[
        ["军品营业收入(G)","b"],
        ["军品承接合同(G)","b"],"提升价值创造能力,4"
        ],
        "3":[
        ["民品营业收入(G)","y"],
        ["民品承接合同(G)","y"],"提升价值创造能力,3"
        ],
        "4":[
        ["两金占流动资产比率(C)","b"],
        ["资产负债率(G)","b"],"提高运营效率,5"
    ...
    "P":{
        ...
        ["完成动力板块涉军研制任务","y"],
        ["完成电子信息板块涉军研制任务","b"],
        ["完成《2045年前国防科技创新和武器装备技术发展战略研究》","b"],"以军为本,4"
        ],
        "2":[
        ["提升武器装备科研生产保障能力","b"],"以军为本,4"
        ],
        "3":[
        ["推动重大军民融合能力基地建设","y"],
        ["优化动力板块产业布局","y"],
        ["推进重点项目与军民融合产业事业群建设","b"],"军民融合,6"
        ],
        "4":[
        ["加强产业投资与管理","y"],"军民融合,6"
        ],
        ...
        "9":[
        ["推进证券市场股权、债券发行","y"],"产融一体,3"
        ],
        "10":[
        ["加强资金、保险和授信等集中管理","y"],"产融一体,3"
        ],
        "11":[
        ["增加海外业务收入和布点","b"],"参与“一带一路”,5"
        ],
        "12":[
        ["加快发展军贸业务","y"],"参与“一带一路”,6"
        ],
        "13":[
        ["推进供给侧改革","y"],"深化改革,5"
        ],
        ...
        ["完成三供一业和厂办大集体移交任务","b"],
        ["完成“晒态势、促提升”任务","b"],
        ["推进集中采购、公车改革","b"],"深化改革,5"
        ],
        "15":[
        ["加强全面风险管理","y"],
        ["力保不出现群体性、恶性上访事件","y"],"监督与控制,5"
        ],
        "16":[
        ["推进“法治船舶”建设","y"],"监督与控制,5"
        ],
        "17":[
        ["加强内审和内控评价工作","b"],
        ["落实监事会工作","b"],"监督与控制,5"
    ...
    "L":{
        ...
        "2":[
        ["完善信息化发展规划","b"],"提高信息化水平,5"
        ],
        "3":[
        ["加强领导干部检查、考核管理","y"],"加强人力资源开发,5"
        ],
        "4":[
        ["加强科技和技能领军人才队伍建设","b"],"加强人力资源开发,5"
        ]
    }
};
