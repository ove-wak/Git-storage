...
gmt psxy locationTaizhan2.txt %R% %J% -St0.25c -G0/0/0 -O -K >> %ps%
gmt psclip shengjie.xyz %R% %J% -O -K >> %ps%
gmt psxy  %R% %J% %BLOCK% -W1.2p,white  -K -O >> %PS%
gmt psmeca zhenyuan2016.txt %R% %J% -Ewhite -Gblue -Sm0.3 -C1 -O -K >> %ps%
gmt psclip -C -O -K >> %ps%
REM 南海
